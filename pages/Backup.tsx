  ...
  const projects = [
    {
      ...
      category: 'Accounting',
      img: 'https://source.unsplash.com/600x400/?finance,accounting',
    },
    {
      title: 'Payroll System Setup',
      category: 'Accounting',
      img: 'https://source.unsplash.com/600x400/?payroll,office',
    },
    {
      title: 'Retail IT Support',
      category: 'IT',
      img: 'https://source.unsplash.com/600x400/?computer,repair',
    },
    {
      title: 'Excel Automation',
      category: 'IT',
      img: 'https://source.unsplash.com/600x400/?excel,spreadsheet',
    },
    {
      title: 'Financial Reports',
      category: 'Accounting',
      img: 'https://source.unsplash.com/600x400/?report,charts',
    },
    {
      title: 'Cloud Migration',
      category: 'IT',
      img: 'https://source.unsplash.com/600x400/?cloud,technology',
    },
  ];
  ...
  return (
    <>
      <Head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;500;700&family=Playfair+Display:wght@400;600;700&display=swap"
          rel="stylesheet"
        />
      </Head>

      {/* Sidebar (dark theme like Simone) */}
        ...
        <nav className="mt-10 flex-1 flex flex-col justify-center items-center gap-7">
          {NAV_ITEMS.map((n) => (
            <a
              key={n.id}
              href={`#${n.id}`}
              className={`text-center text-base tracking-wide transition-colors ${
                activeSection === n.id
                  ? 'text-teal-400 font-semibold'
                  : 'text-white-400 hover:text-teal-400'
              }`}
            >
              {n.label}
            </a>
      ...
      <main className="ml-56">
        ...
        <section id="about" className="py-20 relative bg-gray-50">
          <div className="relative max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-start">
              <div>
                ...
                <p className="text-gray-700 mb-4">
                  I have a background in accounting and IT support, with experience
                  working in both practice and retail management. My work has given me
                  strong skills in financial reporting, payroll, reconciliations, and
                  system improvements.
                </p>
                <p className="text-gray-700 mb-6">
                  I enjoy helping businesses stay accurate and efficient, whether that’s
                  through bookkeeping, payroll, or solving IT challenges.
                </p>
              </div>
              ...
              <div>
                <ul className="space-y-4">
                  <li className="flex justify-between border-b pb-2">
                    ...
                    <span className="text-gray-700">Greig Colliar</span>
                  </li>
                  <li className="flex justify-between border-b pb-2">
                    <span className="font-semibold text-gray-800">Email</span>
                    <a
                      className="text-teal-500"
                      href="mailto:greigcolliar@gmail.com"
                    >
                  ...
                  <li className="flex justify-between pb-2">
                    ...
                    <span className="text-gray-700">Bookkeeping & IT</span>
                  </li>
                </ul>
                <a
                  href="/Greig-CV.pdf"
                  download
                  className="inline-block mt-6 px-6 py-3 bg-teal-500 text-white rounded-lg shadow hover:opacity-90"
                >
                  Download CV
                </a>
              </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 mt-16 text-center">
              <div>
                <h3 className="text-3xl font-bold text-teal-500">3+</h3>
                <p className="text-gray-700 text-sm">Years Experience</p>
              </div>
              <div>
                <h3 className="text-3xl font-bold text-teal-500">15+</h3>
                <p className="text-gray-700 text-sm">Happy Clients</p>
              </div>
              <div>
                <h3 className="text-3xl font-bold text-teal-500">25+</h3>
                <p className="text-gray-700 text-sm">Projects Done</p>
              </div>
              <div>
                <h3 className="text-3xl font-bold text-teal-500">2</h3>
        ...
        <section id="portfolio" className="py-20 bg-gray-50">
          <div className="max-w-6xl mx-auto px-6">
            <SectionHeader title="Portfolio" faint="Work" />

            {/* Filter Bar */}
            <div className="flex justify-center mb-10 gap-6">
              {['All', 'Accounting', 'IT'].map((cat) => (
                <button
                  key={cat}
                  onClick={() => setFilter(cat as 'All' | 'Accounting' | 'IT')}
        ...
        {/* RESUME */}
        <section id="resume" className="py-20 relative bg-gray-50">
          <div className="relative max-w-6xl mx-auto px-6">
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="border-l-4 border-teal-500 pl-4">
                    ...
                    <p className="text-gray-600">Perth College UHI — 2019</p>
                    <p className="text-gray-700 text-sm mt-1">
                      Focused on financial reporting, payroll, and management
                      accounting.
                    </p>
                  </div>
                  <div className="border-l-4 border-teal-500 pl-4">
                    <h4 className="text-lg font-semibold">PDA Bookkeeping</h4>
                    <p className="text-gray-600">Perth College UHI — 2018</p>
                    <p className="text-gray-700 text-sm mt-1">
                      Specialist training in double-entry bookkeeping and tax compliance.
                    </p>
                  </div>
                </div>
              </div>
